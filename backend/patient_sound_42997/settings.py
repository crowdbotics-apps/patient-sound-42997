"""
Django settings for patient_sound_42997 project.
...
ROOT_URLCONF = 'patient_sound_42997.urls'
...
WSGI_APPLICATION = 'patient_sound_42997.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_sound_42997 API",
    "DESCRIPTION": "API documentation for patient_sound_42997 App",
    "VERSION": "v1",
}
